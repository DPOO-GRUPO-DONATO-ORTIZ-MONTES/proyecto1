...
public class InterfazEmpleado extends JFrame{
	private JButton tiquete, usuarios;
    public InterfazEmpleado() {
        super("pantalla Empleados");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setSize(600, 500);
        setLayout(new BorderLayout());
        
        JLabel titulo = new JLabel("Empleado", SwingConstants.CENTER);
        ...
        usuarios.setPreferredSize(new Dimension(200, 60));

       
        setLayout(new FlowLayout()); 
        panelCentral.add(tiquete);
        panelCentral.add(usuarios);
        ...
        usuarios.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
            	VistaUsuariosEmpleado VistaUsuariosEMP= new VistaUsuariosEmpleado(); 
